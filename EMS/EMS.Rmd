...
Running the EMS analysis. The `IdentifyStructure` functin is a function created to run the same analysis for multiple datasets and automatically identify the idealized metacommunity structure.
